...
public class GeneMentionAnnotator extends JCasAnnotator_ImplBase {
	...
	/**
	 * The process uses LingPipe to get the gene mentions, then creates NERAnnotation for each of the gene mentions. 
	 * The NER Annotation's are added into the corresponding JCas. 
	 * There is also a little big of filtering: the single lower case letter that are matched in LingPipe was deleted.
	 * 
	 * @param aJCas the JCas object corresponding to one line in hw1.in
